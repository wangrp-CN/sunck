...
class LocateDevice(Base, TimestampMixin, CreatorMixin):
...
class AntiIntrusionDevice(Base, TimestampMixin, CreatorMixin):
...
class TrainApproachDevice(Base, TimestampMixin, CreatorMixin):
