...
| ⑥ | **报表导出对称化** | 后端 | P2 | 🔲 待排期 | 隐患/设备 Excel·PDF 导出补齐 |
| ⑦ | **数据字典 / 枚举中心** | 全栈 | P3 | 🔲 待排期 | 设备类型、告警类型等枚举可视化维护 |
| ⑧ | **视频 AI 分析** | 重 | P3 | 🔲 待评估 | 需视频流接入 + 推理服务 |
| ⑨ | **巡检 / 打卡 / 履职** | 全栈 | P3 | 🔲 待评估 | 与人员定位联动 |
| ⑩ | **作业计划模板 / 克隆** | 后端 | P3 | 🔲 待排期 | 复用现有 WorkPlan 模型 |
| ⑪ | **多项目对比大屏** | 全栈 | P3 | 🔲 待评估 | 聚合多项目 KPI |
| ⑫ | **设备健康 / 运维** | 全栈 | P3 | 🔲 待评估 | 设备在线率、故障统计 |
...
### P3 · 业务扩展（需需求确认）— 待启动
按监管与现场反馈优先级逐步启动；⑧⑨⑪⑫ 属重投入项，建议先行小范围 PoC。
